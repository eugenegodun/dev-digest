/* /skills/:id — Skill Editor page. Left skills list + tabbed Config editor.
...
import { TYPE_COLORS } from "@/app/skills/_components/SkillCard/constants";

export function SkillEditorPage({ id }: { id: string }) {
  ...
  const typeColors = skill ? TYPE_COLORS[skill.type] : null;
        ...
        {isLoading || !skill ? (
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0, minHeight: 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "16px 28px 0", flexShrink: 0 }}>
              ...
              {typeColors && (
                <Badge color={typeColors.text} bg={typeColors.bg}>
                  {skill.type}
                </Badge>
              )}
